...
class EmailBuilder:
    ...
    def update_profile(params):
        msg = ""
        msg += "<HTML><BODY>"
        msg += "<h2>" + "Your Profile has been updated successfully!! " + params['firstName'] + params['lastName'] + "<h2>"
        msg += "<p><b>" + "To access account user login id: " + params["login"] + " Password : " + params["password"] + "<b></p>"
        msg += "</BODY></HTML>"
        return msg